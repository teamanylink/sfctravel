    ...
    <section id="booking" className="bg-[#fcfcfc] py-32 lg:py-48 border-t border-navy-900/5">
      <div className="max-w-4xl mx-auto px-6 lg:px-12">
        <div className="text-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <p className="text-xl font-light text-navy-900/50 max-w-2xl mx-auto leading-relaxed mb-16">
          ...
          <Link
            href="/login"
            className="inline-block py-5 px-16 bg-navy-900 text-white text-xs font-medium tracking-[0.2em] uppercase rounded-xl hover:bg-navy-800 transition-all duration-500 hover:-translate-y-1 hover:shadow-lg"
          >
